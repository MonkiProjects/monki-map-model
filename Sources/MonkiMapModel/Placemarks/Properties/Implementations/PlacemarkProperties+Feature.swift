//
//  PlacemarkProperties+Feature.swift
//  MonkiMapModel
//
...
public extension Placemark.Properties {
	...
	enum Feature: String, Codable, Hashable, DefaultCaseDecodable {
		...
		public static func allowed(for kind: Placemark.Kind) throws -> [Placemark.Property] {
			return kind == .unknown ? [] : try kind.internal(in: Locale.en).allowedFeatures
		}
		
	}
	
	static func feature(_ feature: Feature) -> Placemark.Property {
		return .init(id: feature.rawValue, kind: .feature)
	}
	
}

/// Extend for testing purposes
extension Placemark.Properties.Feature: CaseIterable {}
